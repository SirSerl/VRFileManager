    ...
    public class KeyboardCreator : KeyboardComponent {
        ...
        public void InitKeys() {
            if (keys == null || KeyboardItem.forceInit) {
                List<KeyboardItem> allKeys = new List<KeyboardItem>(GetComponentsInChildren<KeyboardItem>(true));
        ...
        public void checkErrors () {
            ...
            if(keys.Length != KEY_NUMBER) {//is there correct number of keys
                errorReporter.SetMessage("Cannot proceed. Number of keys is incorrect. Revert your changes to prefab", ErrorReporter.Status.Error);
                return;
            }
            ...
            if(space.GetMeshName().Equals(MESH_NAME_SEARCHED)) {//are keys positioned corectly
                errorReporter.SetMessage("Cannot proceed. Space key data is incorrect. Revert your changes to prefab or place keys in correct sequence", ErrorReporter.Status.Error);
                return;
            }
